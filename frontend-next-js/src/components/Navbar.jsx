...
export default function Navbar() {
    ...
    const [userEmail, setUserEmail] = useState("user@example.com"); // ✅ Use state
        ...
        >
            ...
            >
                ...
                <Box 
                    ...
                    onClick={() => router.push('/home')} // ✅ Use router.push instead of navigate
                >
                    <Box
                        sx={{
                            position: 'relative',
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                    ...
                    {!isMobile && (
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mr: 2 }}>
                            ...
                            <IconButton 
                                size="medium"
                                onClick={() => router.push('/wishlist')} // ✅ Use router.push
                                sx={{ 
                                    color: '#6c757d',
                                    '&:hover': { 
                                        backgroundColor: 'rgba(244, 162, 97, 0.1)',
