...
urlpatterns = [
    ...
    path('<int:tournament_id>/upload-logo/',
         views.upload_tournament_logo, name='upload-tournament-logo'),
    ...
    path('<int:tournament_id>/<int:sport_id>/teams/<int:team_id>/upload-logo/',
         views.upload_team_logo, name='upload-team-logo'),
    ...
    path('<int:tournament_id>/<int:sport_id>/teams/<int:team_id>/<int:team_member_id>/upload-photo/',
         views.upload_team_member_photo, name='upload-team-member-photo'),
