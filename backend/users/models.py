...
class User(AbstractUser):
    ...
    profile_picture = models.ImageField(upload_to=user_profile_image_path, validators=[FileExtensionValidator(allowed_extensions=['jpg', 'jpeg', 'png'])], blank=True, null=True, help_text="Upload a profile picture (JPG, JPEG, PNG only)")
    STATUS_CHOICES = [
        ('student', 'Student'),
        ('staff', 'Staff'),
        ('others', 'Others'),
